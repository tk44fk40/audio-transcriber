...
description: audio-transcriber の開発ルール (.agents/AGENTS.md) に準拠し、Issue/ブランチ準備・シグネチャ合意・TDD・自動検証・セルフチェック・PR作成・スカッシュマージまでを自律完遂する実装スキル
---

# 自律的コード実装 ＆ 品質保証ワークフロー (`autonomous-code-workflow`)

短文指示を受け、以下の 7 段階自律ワークフローを厳格に順次実行すること。
